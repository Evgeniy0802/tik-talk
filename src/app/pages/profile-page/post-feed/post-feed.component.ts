...
import {debounceTime, firstValueFrom, fromEvent, Subject, takeUntil, throttleTime} from "rxjs";
...
export class PostFeedComponent {
  ...
  onCreatePost(postText: string) { //принимаем текс поста передал то что вбито в textarea
